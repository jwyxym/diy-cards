...
function s.atkfilter(c)
	return c:IsPreviousPosition(POS_FACEUP) and c:GetOriginalType()&TYPE_NORMAL>0
end
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	local b1=Duel.IsExistingMatchingCard(Card.IsFaceup,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) and eg:IsExists(s.atkfilter,1,nil,e,tp)
	local b2=Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and eg:IsExists(s.atkfilter,1,nil,e,tp)
