...
function cm.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetAttackTarget()
		and (Duel.GetAttacker():IsControler(tp) and Duel.GetAttacker():IsSetCard(0xccf))
			or (Duel.GetAttackTarget():IsControler(tp) and Duel.GetAttackTarget():IsSetCard(0xccf))
end
