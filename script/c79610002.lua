...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetMZoneCount(tp,c)>0 and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_DECK+LOCATION_HAND,0,1,nil,e,tp) end
...
function s.spfilter2(c,e,tp)
	return c:IsSetCard(0x171) and not c:IsCode(id) and c:IsType(TYPE_MONSTER)
