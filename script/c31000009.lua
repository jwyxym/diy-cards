...
function cm.filter1(c)
	return c:IsSetCard(0x310) and not Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_GRAVE,0,1,nil,c:GetCode()) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
