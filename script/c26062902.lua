...
function s.initial_effect(c)
    ...
    -- ② 被从牌组以外的地方送墓时，堆墓鸟兽族以外的记述「春日影」怪兽
...
-- ② 堆墓对象：记述「春日影」、怪兽、鸟兽族以外
function s.tgfilter(c)
    return aux.IsCodeListed(c,26062911) and c:IsType(TYPE_MONSTER) and not c:IsRace(RACE_WINDBEAST) and c:IsAbleToGrave()
end
