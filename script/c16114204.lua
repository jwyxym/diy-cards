...
function cm.rmfilter(c,e,tp)
	return c:IsAbleToRemoveAsCost() and c:IsSetCard(0xccf) and c:IsType(TYPE_MONSTER) and Duel.IsExistingMatchingCard(Card.IsAbleToRemove,tp,LOCATION_DECK,0,1,c)
end
