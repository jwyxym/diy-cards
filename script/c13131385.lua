...
function c13131385.btf(c,ac)
	return c:IsCode(13131370) or c==ac
end
...
function c13131385.disf1(c)
	return c:IsCode(13131370) and c:IsFaceup()
end
...
function c13131385.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_DISABLE,nil,num,1-tp,LOCATION_ONFIELD)
...
function c13131385.op(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=g:Select(tp,num,num,nil)
