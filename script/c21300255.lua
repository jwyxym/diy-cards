...
function this.filter2(c,e,tp,m,f,chkf)
	return c:IsType(TYPE_FUSION) and c:IsSetCard(0x677) and (not f or f(c))
...
function this.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		mg1:Merge(Duel.GetMatchingGroup(this.filter0,tp,LOCATION_EXTRA,0,nil,e))
