...
function s.tdfilter(c)
	return c:IsFaceup() and c:IsType(TYPE_CONTINUOUS) and c:IsAbleToHand()
end
...
function s.tdop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,s.tdfilter,tp,LOCATION_SZONE,LOCATION_SZONE,1,1,nil)
