...
function this.limtg(e,c)
    return not c:IsRace(RACE_SPELLCASTER|RACE_WARRIOR)
end
...
function this.thfilter(c)
	return c:IsSetCard(0x675) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(id)
end
