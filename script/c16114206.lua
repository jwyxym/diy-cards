...
local m,cm=rk.set(16114206,nil,1)
...
function cm.spc(c,e,tp,lv)
	return c:IsLevel(lv) and c:IsType(TYPE_RITUAL) and c:IsSetCard(0xccf) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,false,true)
end
