...
function c51900007.initial_effect(c)
	...
	e6:SetCountLimit(1,51900007+10000)
	e6:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e6:SetOperation(c51900007.cop)
	c:RegisterEffect(e6)
end
function c51900007.cop(e,tp,eg,ep,ev,re,r,rp)
	Debug.Message("迷途的羔羊，终末已经到临。")
	Debug.Message("神不会看到渺小的蚂蚁，你们的挣扎从来都没有意义。一切都将在绝望中溃散。")
	Debug.Message("让我们牵起终焉的木偶，醒来吧，辛西娅。")
end
