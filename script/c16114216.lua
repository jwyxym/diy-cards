...
local m,cm=rk.set(16114216,nil,1)
...
function cm.cfilter2(c,tp)
	return c:IsSetCard(0xccf) and c:GetSummonPlayer()==tp and c:IsFaceup()
end
...
function cm.stfilter(c)
	return c:IsSetCard(0xccf) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsSSetable()
end
