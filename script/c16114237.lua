...
local m,cm=rk.set(16114237,"RYUUHA")
...
function cm.aclimit(e,re,tp)
	return re:IsActiveType(TYPE_MONSTER) and re:GetHandler():IsAttackBelow(e:GetLabel())
end
function cm.effcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetEquipTarget() and re:GetHandler()==e:GetHandler():GetEquipTarget()
end
