...
function s.thfilter(c)
	return ((c:IsSetCard(0xdf99) and (c:GetType()==TYPE_SPELL or c:GetType()==TYPE_TRAP)) or c:IsCode(16820660))
    	and c:IsAbleToHand()
end
...
function s.filter2(c,e,tp,m,f,chkf)
	return c:IsType(TYPE_FUSION) and (not f or f(c)) and c:IsSetCard(0xdf99)
