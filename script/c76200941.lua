...
function s.exfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x763) and c:GetSequence()>=5
end
...
function s.thfilter(c)
	return c:IsRace(RACE_PLANT) and c:IsType(TYPE_PENDULUM) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
