...
function s.counterfilter(c)
	return not c:IsSummonLocation(LOCATION_EXTRA) or (c:IsRace(RACE_WARRIOR) and c:IsType(TYPE_FUSION))
end
...
function s.spfilter(c,tp,se)
	return c:IsSummonPlayer(tp) and c:IsRace(RACE_WARRIOR) and c:IsType(TYPE_FUSION) and c:IsFaceup()
