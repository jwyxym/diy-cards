...
function s.initial_effect(c)
	...
	e4:SetProperty(EFFECT_FLAG_SET_AVAILABLE+EFFECT_FLAG_PLAYER_TARGET)
...
function s.thfilter(c)
	return c:IsSetCard(0xc1c6) and c:IsAbleToHand()
end
...
function s.setfilter(c)
	return c:IsSetCard(0x2eb,0xc1c6) and c:IsType(TYPE_TRAP) and c:IsSSetable()
end
...
function s.rmlimit(e,c,tp,r,re)
	return c:IsLocation(LOCATION_SZONE) and c:GetSequence()<5 and c:IsFacedown()
end