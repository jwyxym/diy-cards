...
function s.thfilter(c)
	return c:IsFaceupEx() and c:IsSetCard(0x725) and c:IsAbleToHand()
end
...
function s.valcheck(e,c)
	...
	if g:IsExists(Card.IsSetCard,1,nil,0x725) then
...
function s.rmfilter(c)
	return c:IsSetCard(0x725) and c:IsAbleToRemoveAsCost()
end
