--冻原之影 寒灾
function c21300000.initial_effect(c)
	...
	e1:SetCountLimit(1,21300000)
	e1:SetCondition(c21300000.condition1)
	e1:SetCost(c21300000.cost1)
	e1:SetTarget(c21300000.target1)
	e1:SetOperation(c21300000.activate1)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e4:SetTarget(c21300000.reptg)
	c:RegisterEffect(e4)
end
function c21300000.condition1(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentChain()==0 and eg:IsExists(Card.IsControler,1,nil,1-tp)
end
function c21300000.cost1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,2,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,2,2,REASON_COST)
end
function c21300000.target1(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c21300000.activate1(e,tp,eg,ep,ev,re,r,rp)
...
function c21300000.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
