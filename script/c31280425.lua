...
function s.sprfilter(c)
	return c:IsFaceup() and (c:IsCode(31280416) or (aux.IsCodeListed(c,31280416) and c:IsType(TYPE_MONSTER) and c:GetOriginalAttribute()~=ATTRIBUTE_DARK))
end
...
function s.tgfilter(c)
	return not c:IsCode(id) and aux.IsCodeOrListed(c,31280416) and c:IsAbleToGrave()
end
