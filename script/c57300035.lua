...
function s.initial_effect(c)
	aux.AddLinkProcedure(c,aux.FilterBoolFunction(Card.IsLinkRace,RACE_BEASTWARRIOR),2,2,s.lkcheck)
	c:EnableReviveLimit()
...
function s.mfilter(c)
	return c:IsLinkCode(57300013) or (c:IsLinkAbove(2) and c:IsLinkRace(RACE_BEASTWARRIOR))
end
-- ①效果条件：本回合召唤·特殊召唤合计≥5
function s.cond1(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(tp,id)>=5
end
