...
function s.filter(c,g)
	return c:IsType(TYPE_SPELL+TYPE_TRAP) and not g:IsContains(c)
end
...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.filter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,1,nil,cg)
	local tc=g:GetFirst()
