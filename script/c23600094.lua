...
function s.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(s.rmfilter,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,c)
end
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,c)
	local g=Duel.GetMatchingGroup(s.rmfilter,tp,LOCATION_GRAVE+LOCATION_HAND,0,c)
...
function s.thfilter(c)
	return c:IsSetCard(0xd80) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end
