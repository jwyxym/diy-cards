...
function s.filter2(c,e,tp,m,f,chkf)
	return c:IsType(TYPE_FUSION) and c:IsRace(RACE_FIEND) and c:IsAttribute(ATTRIBUTE_DARK) and (not f or f(c))
...
function s.thfilter(c)
	return (c:IsCode(72600251) or aux.IsCodeListed(c,72600251)) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
